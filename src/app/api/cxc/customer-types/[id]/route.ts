...
import { saveTipoCliente, deleteTipoCliente } from "@/lib/pos-data"
...
export async function PUT(request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const result = await saveTipoCliente({ id: numId, code: body.code, name: body.name, active: body.active })
