...
import { updateDivision, deleteDivision } from "@/lib/pos-data"
...
export async function PUT(request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const result = await updateDivision(numId, { name: body.name, description: body.description, active: body.active })
