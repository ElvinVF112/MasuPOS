...
import { updateBranch, deleteBranch } from "@/lib/pos-data"
...
export async function PUT(request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const result = await updateBranch(numId, { divisionId: body.divisionId, name: body.name, description: body.description, address: body.address, active: body.active })
