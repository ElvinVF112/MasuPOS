-- TAREA 26: Paso 1 - Recrear SPs sin referencias a columnas CRUD
-- (Las columnas ya fueron eliminadas; aqui se recrean los SPs limpios)

-- ══════════════════════════════════════════════════════════════
-- spPermisosObtenerPorRol
-- ══════════════════════════════════════════════════════════════
...
-- ══════════════════════════════════════════════════════════════
-- spRolPermisosPorModulo (ScreenPermissionBase defaults a 0)
-- ══════════════════════════════════════════════════════════════
