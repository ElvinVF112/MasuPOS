...
-- Agregar AplicaPropina a Empresa
IF COL_LENGTH('dbo.Empresa', 'AplicaPropina') IS NULL
BEGIN
    ALTER TABLE dbo.Empresa
    ADD AplicaPropina BIT NOT NULL
        CONSTRAINT DF_Empresa_AplicaPropina DEFAULT (0);
END
GO

-- Agregar PorcentajePropina a Empresa
IF COL_LENGTH('dbo.Empresa', 'PorcentajePropina') IS NULL
BEGIN
    ALTER TABLE dbo.Empresa
    ADD PorcentajePropina DECIMAL(5,2) NOT NULL
        CONSTRAINT DF_Empresa_PorcentajePropina DEFAULT (10.00);
END
GO
...
BEGIN
    ...
    BEGIN
        ...
        (
            ...
            SesionDuracionMinutos, SesionIdleMinutos, AplicaPropina, PorcentajePropina,
