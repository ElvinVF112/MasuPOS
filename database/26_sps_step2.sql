-- TAREA 26: Paso 2 - Drop SPs → Drop columns → Recreate clean SPs
-- Este script limpia completamente las referencias de tabla y elimina las columnas CRUD
...
-- ══════════════════════════════════════════════════════════════
-- PASO 2: Drop columnas CRUD de Permisos
-- ══════════════════════════════════════════════════════════════
ALTER TABLE Permisos DROP COLUMN [ueddeVer];
ALTER TABLE Permisos DROP COLUMN [ueddeCrear];
ALTER TABLE Permisos DROP COLUMN [ueddeEditar];
ALTER TABLE Permisos DROP COLUMN [ueddeEliminar];
ALTER TABLE Permisos DROP COLUMN [ueddeAprobar];
ALTER TABLE Permisos DROP COLUMN [ueddeAnular];
ALTER TABLE Permisos DROP COLUMN [ueddeImprimir];
GO

-- ══════════════════════════════════════════════════════════════
-- PASO 3: Recrear SPs limpios (de 26_sps_step1.sql)
-- ══════════════════════════════════════════════════════════════
...
PRINT 'TAREA 26 Paso 2 completado: columnas eliminadas y SPs recreados.';
