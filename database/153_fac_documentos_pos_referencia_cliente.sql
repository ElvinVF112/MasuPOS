-- ============================================================
-- 153_fac_documentos_pos_referencia_cliente.sql
-- Renombra NombreCliente → ReferenciaCliente en FacDocumentosPOS
-- y actualiza spFacDocumentosPOSCRUD
-- ============================================================
...
IF EXISTS (
    ...
    WHERE object_id = OBJECT_ID('dbo.FacDocumentosPOS')
      AND name = 'NombreCliente'
)
BEGIN
    EXEC sp_rename 'dbo.FacDocumentosPOS.NombreCliente', 'ReferenciaCliente', 'COLUMN';
    PRINT 'Columna renombrada NombreCliente -> ReferenciaCliente';
END
ELSE
    PRINT 'Columna NombreCliente no existe (ya renombrada o nunca creada)';
GO
...
BEGIN
    ...
    BEGIN
        SELECT
            ...
            D.ReferenciaCliente, D.Referencia,
    ...
    BEGIN
        ...
        SELECT DL.IdDetalle, DL.NumLinea, DL.IdProducto, DL.Codigo, DL.Descripcion,
            ...
            DL.AplicaImpuesto, DL.AplicaPropina, DL.DescuentoLinea
        FROM dbo.FacDocumentoPOSDetalle DL
...
PRINT 'Script 153 aplicado correctamente.';
GO
