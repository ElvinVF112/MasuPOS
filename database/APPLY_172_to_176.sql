-- ============================================================
-- APPLY 172 → 176: Migración consolidada FacDocumentos
-- Ejecutar completo en SSMS contra DbMasuPOS
-- Es idempotente — verifica existencia antes de cada cambio
-- ============================================================

PRINT '=== Iniciando migración 172-176 ==='
GO

-- ════════════════════════════════════════════════════════════
-- SCRIPT 172: Limpieza columnas FacDocumentos
-- ════════════════════════════════════════════════════════════

-- 1. Drop índice que puede bloquear columnas
...
-- 2. Drop IX_FacDocumentos_PuntoEmision_Fecha si bloquea columnas
...
-- 3. Drop DocumentoNumero (columna computada)
...
-- 6. Drop Anulado (con su DEFAULT constraint)
...
-- 10. Agregar DocumentoSecuencia si no existe
...
-- 11. Poblar DocumentoSecuencia en registros existentes
...
-- 13. Recrear índice PuntoEmision_Fecha sin columnas eliminadas
SET QUOTED_IDENTIFIER ON;
GO
...
-- 14. FacTiposDocumento: eliminar Codigo
...
PRINT '=== Script 172-173 completado ==='
GO

-- ════════════════════════════════════════════════════════════
-- SCRIPT 175: FacTiposDocumento - Drop GeneraFactura
-- ════════════════════════════════════════════════════════════
...
PRINT '=== Script 175 tabla completado ==='
GO

-- ════════════════════════════════════════════════════════════
-- STORED PROCEDURES: versión final (script 176)
-- Incluye: rebaja de stock al emitir, devolución al anular
-- ════════════════════════════════════════════════════════════

-- spFacTiposDocumentoCRUD (sin GeneraFactura ni Codigo)
...
PRINT '=== spFacTiposDocumentoCRUD recreado ==='
GO

-- spEmitirFacturaPOS (con rebaja de stock)
...
BEGIN
  ...
  BEGIN TRY
    ...
    -- Validar stock si el tipo de documento afecta inventario
...
PRINT '=== spEmitirFacturaPOS recreado ==='
GO

-- spFacDocumentosCRUD (versión final con devolución de stock al anular)
...
BEGIN
  ...
  BEGIN
    ...
    -- Devolver stock si el tipo de documento afecta inventario
...
PRINT '=== spFacDocumentosCRUD recreado ==='
GO
