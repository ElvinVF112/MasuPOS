-- ============================================================
-- Script 176: Rebaja de stock al emitir factura
-- spEmitirFacturaPOS: si AfectaInventario=1 en el tipo documento,
-- descuenta Cantidad de ProductoAlmacenes para cada linea con ManejaExistencia=1.
-- Si VenderSinExistencia=0 y no hay stock suficiente, lanza error.
-- spFacDocumentosCRUD accion 'A' (Anular): devuelve stock si AfectaInventario=1.
-- ============================================================
...
BEGIN
  ...
  BEGIN TRY
    ...
    -- Rebajar stock si el tipo de documento afecta inventario
...
-- ── spFacDocumentosCRUD: accion 'A' devuelve stock si AfectaInventario=1 ──
-- Se recrea completo para incluir la devolucion de stock al anular
...
PRINT 'Script 176 aplicado correctamente.';
GO
